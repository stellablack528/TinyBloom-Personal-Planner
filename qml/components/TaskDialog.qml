...
Dialog {
    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                spacing: 3
                Text { text: dialog.editing ? "Edit task" : "Create a small step"; color: theme.text; font.pixelSize: 23; font.weight: Font.Bold }
                Text { text: dialog.editing ? "Adjust what matters, and keep moving." : "Keep it simple — you can add details later."; color: theme.muted; font.pixelSize: 13 }
            }
        ...
        ScrollView {
            ...
            ColumnLayout {
                ...
                Text { text: "Task name"; color: theme.text; font.pixelSize: 13; font.weight: Font.DemiBold }
                AppTextField {
                    id: titleField; theme: dialog.theme; Layout.fillWidth: true; placeholderText: "e.g. Read 10 pages"
                    maximumLength: 160; onAccepted: dialog.submit()
                }
                CheckBox {
                    id: moreOptions; text: "More options"; checked: dialog.editing
                ...
                ColumnLayout {
                    ...
                    Text { text: "Description"; color: theme.text; font.pixelSize: 13; font.weight: Font.DemiBold }
                    ScrollView {
                        Layout.fillWidth: true; Layout.preferredHeight: 92
                        TextArea {
                            id: descriptionField; color: theme.text; placeholderText: "Notes or context (optional)"; placeholderTextColor: theme.muted
                    ...
                    GridLayout {
                        ...
                        Text { text: "Due date"; color: theme.text; font.pixelSize: 13; font.weight: Font.DemiBold }
                        Text { text: "Priority"; color: theme.text; font.pixelSize: 13; font.weight: Font.DemiBold }
                        AppTextField { id: dueField; theme: dialog.theme; Layout.fillWidth: true; placeholderText: "YYYY-MM-DD"; maximumLength: 10 }
                        ComboBox {
                            id: priorityBox; Layout.fillWidth: true; model: ["Low", "Medium", "High"]
                        ...
                        Text { text: "Estimate (minutes)"; color: theme.text; font.pixelSize: 13; font.weight: Font.DemiBold }
                        Text { text: "Category"; color: theme.text; font.pixelSize: 13; font.weight: Font.DemiBold }
                        SpinBox {
                        ...
                        AppTextField { id: categoryField; theme: dialog.theme; Layout.fillWidth: true; placeholderText: "Personal"; maximumLength: 80 }
                    }
                    ColumnLayout {
                        visible: dialog.editing; Layout.fillWidth: true; spacing: 8; Layout.topMargin: 4
                        Text { text: "Small steps"; color: theme.text; font.pixelSize: 14; font.weight: Font.DemiBold }
                        Repeater {
                        ...
                        RowLayout {
                            Layout.fillWidth: true
                            AppTextField { id: subtaskField; theme: dialog.theme; Layout.fillWidth: true; placeholderText: "Add a small step"; maximumLength: 160; onAccepted: addStepButton.clicked() }
                            AppButton {
                                id: addStepButton; theme: dialog.theme; text: "Add"; primary: false
        ...
        RowLayout {
            Layout.fillWidth: true
            AppButton {
                visible: dialog.editing; theme: dialog.theme; text: "Delete"; primary: false; danger: true
            ...
            AppButton { theme: dialog.theme; text: dialog.editing ? "Save changes" : "Create"; onClicked: dialog.submit() }
        }
    }
}
